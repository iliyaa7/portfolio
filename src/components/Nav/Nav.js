...
function Nav(props) {
  ...
  if(props.isPopup) {
    return (
      <nav className='nav nav_type_popup'>
        ...
        <a onClick={props.onClose} href='#main' className='nav__link nav__link_type_popup'>About me</a>
        <a onClick={props.onClose} className='nav__link nav__link_type_popup'>Skills</a>
        <a onClick={props.onClose} className='nav__link nav__link_type_popup'>Portfolio</a>
        ...
        <a onClick={props.onClose} className='nav__link nav__link_type_white nav__link_type_popup'>CONTACT ME</a>
      </nav>
    )
  }
  ...
  return (
    <nav className='nav'>
      <a href='#main' className='nav__link'>Home</a>
      <a href='#main' className='nav__link'>About me</a>
      <a className='nav__link'>Skills</a>
      <a className='nav__link'>Portfolio</a>
      <a className='nav__link nav__link_type_white'>CONTACT ME</a>
    </nav>
  );
}
